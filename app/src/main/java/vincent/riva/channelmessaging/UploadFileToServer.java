...
public class UploadFileToServer extends AsyncTask<String, Integer, String> {
     ...
     */
    public UploadFileToServer(Context context, String filePath, HashMap<String, String> values,OnUploadFileListener onUploadFileListener) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            outputStream.writeBytes(lineEnd);
            for (Map.Entry<String, String> post : mParameters.entrySet()) {
                outputStream.writeBytes(twoHyphens + boundary + lineEnd);
                outputStream
